...
//       home: ConfirmacionDeSuOrden(),
//     );
//   }
// }

// class ConfirmacionDeSuOrden extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       backgroundColor: Color(0xFFD3DBDE), // Color de fondo similar al mostrado
//       appBar: AppBar(
//         backgroundColor: Color(0xFFD3DBDE),
//         elevation: 0,
//         leading: Icon(
...
//             // Subtitle
//             Text(
//               'Por favor, confirma que los detalles de tu pedido sean correctos para proceder con la compra.',
...
//               child: ListView(
//                 children: [
//                   buildProductRow('HYUNDAI GRAND I10', 'S/. 220.70'),
//                   buildProductRow('TOYOTA YARIS', 'S/. 174.90'),
//                   buildProductRow('HYUNDAI ACCENT', 'S/. 280.60'),
//                 ],
//               ),
//             ),
...
//   Widget buildProductRow(String product, String price) {
//     return Padding(
